...
- Switch the preview background color, including transparent
- Support dotLottie state machines alongside Rive state machines
- Size the preview window to the animation's aspect ratio
